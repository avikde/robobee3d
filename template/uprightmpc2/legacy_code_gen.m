...
% Is column major
def.OutputFcnSpec = 'void umpcS(single y1[3], single y2[6], single u1[3], single u2[3][3], single u3[6], single u4[3], single u5[3], single u6[3], single u6, single u7, single u8, single u9, single u10, single u11, single u12, single u13, single u14, single u15, single u16, single u17, single u18[3], int32 u19, single u20)';
