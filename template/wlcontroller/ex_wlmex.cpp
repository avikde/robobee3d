 ...
 *    C++ source code generated on : 20-Aug-2020 20:43:30
 *
...
/**
     ...
     def.SourceFiles = {'wlcontroller.cpp', 'wlqp.cpp', 'auxil.c', 'error.c', 'kkt.c', 'lin_alg.c', 'osqp.c', 'proj.c', 'qdldl.c', 'qdldl_interface.c', 'scaling.c', 'util.c', 'workspace.c'};
