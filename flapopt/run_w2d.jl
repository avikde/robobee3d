...
results = nonlinBenefit("../../../Dropbox (Personal)/nonlinbig.zip", ret1, range(0, 3, length=5), range(180, 360, length=5); Φ=120, Qdt=1e4, τ2eq=true, tol=5e-2) # SLOW
pls = plotNonlinBenefit("nonlin.zip", [180,360]; s=1000)
plot(pls...)
gui()
