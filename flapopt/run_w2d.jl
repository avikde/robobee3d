...
function opt1(traj, param, mode, minal; testAffine=false, testAfter=false)
	...
	param1, paramObj, traj1, unactErr = cu.optAffine(m, opt, traj, param, mode, optoptions...; Fext_pdep=true, test=testAffine, testTrajReconstruction=false, print_level=1, max_iter=2000)
	if testAfter
