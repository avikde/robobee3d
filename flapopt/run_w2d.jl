...
param1, paramObj, unew = cu.optAffine(m, opt, traj0, param0, 2, (zeros(4,4), 1.0, 0.01*ones(1,1)); test=false, hessreg=1e-3, print_level=1)
...
display(param1')
pls = plotParamImprovement(m, opt, trajt, [param0, param1], traj0, unew, paramObj)
plot(pls...)
